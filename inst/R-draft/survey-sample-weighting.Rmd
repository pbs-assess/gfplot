...
bio_specs %>% join_comps_commercial(catch, age) %>%
  weight_comps()
bio_specs %>% join_comps_commercial(catch, length, bin_size = 2) %>%
  weight_comps()

survey_specimens %>% join_comps_survey(survey_tows, age) %>%
  weight_comps()
survey_specimens %>% join_comps_survey(survey_tows, length, bin_size = 2) %>%
  weight_comps()
