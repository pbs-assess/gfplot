...
There's also a bonus function that we plan to use for the description at the top. Look up the SARA/COSEWIC status of your favorite species! This gets scraped dynamically from tables on a website.
