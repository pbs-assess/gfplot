...
vb_m <- fit_vb(combined_samples, sex = "male", method = "mpd")
vb_f <- fit_vb(combined_samples, sex = "female", method = "mpd")
...
`f()` in the next chunk is a custom helper function to generate sequential factor values that can be safely passed to TMB. Anything that should be treated as a factor (except year) should be wrapped in it.
