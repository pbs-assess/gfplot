SELECT SURVEY_SERIES_DESC AS Survey,
	MIN(YEAR(TRIP_START_DATE)) AS "First Year",
	MAX(YEAR(TRIP_START_DATE)) AS "Last Year",
	COUNT(DISTINCT(YEAR(TRIP_START_DATE))) AS "Surveys Conducted", 
	ISNULL(A.COUNT,0) AS "Surveys Conducted Since 2008"
