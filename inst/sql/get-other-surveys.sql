SELECT S.SURVEY_SERIES_ID,
	SURVEY_SERIES_DESC,
	SURVEY_SERIES_HISTORIC_DESC,
	MIN(YEAR(TRIP_START_DATE)) AS MIN_YEAR,
	MAX(YEAR(TRIP_START_DATE)) AS MAX_YEAR,
	COUNT(DISTINCT(YEAR(TRIP_START_DATE))) AS COUNT_SURVEYS, 
	ISNULL(A.COUNT,0) AS COUNT_SURVEYS_SINCE_2008
