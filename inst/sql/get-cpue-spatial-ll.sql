SELECT
	...
	GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.LANDED_COUNT AS cpue,
	GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.SUBLEGAL_RELEASED_COUNT + GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.LEGAL_RELEASED_COUNT AS TOTAL_RELEASED_PCS,
...
HAVING 
	...
	YEAR(GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.BEST_DATE) >= 2008 AND
