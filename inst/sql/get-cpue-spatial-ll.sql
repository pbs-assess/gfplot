SELECT
  ...
  GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.SUBLEGAL_RELEASED_COUNT +
    GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.LEGAL_RELEASED_COUNT AS RELEASED_PCS
FROM
  GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH INNER JOIN
    GFFOS.dbo.SPECIES SP ON
    GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.SPECIES_CODE = SP.SPECIES_CODE
GROUP BY
  ...
  SP.SPECIES_COMMON_NAME,
    GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.SUBLEGAL_RELEASED_COUNT +
    GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.LEGAL_RELEASED_COUNT,
  GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.LANDED_ROUND_KG,
  GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.SPECIES_CODE,
  SP.SPECIES_CODE
HAVING
  (GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH.GEAR IN ('HOOK AND LINE','LONGLINE','TRAP',
      'LONGLINE OR HOOK AND LINE','TRAP OR LONGLINE OR HOOK AND L')) AND
