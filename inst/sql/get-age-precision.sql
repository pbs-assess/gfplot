SELECT SA.SPECIMEN_ID, YEAR(SM.SAMPLE_DATE) AS YEAR, C.SPECIES_CODE, S.SPECIES_COMMON_NAME, SA.AGE_READING_TYPE_CODE,
...
FROM   GFBioSQL.dbo.AGEING_METHOD INNER JOIN
                  GFBioSQL.dbo.SPECIMEN_AGE SA ON
                  GFBioSQL.dbo.AGEING_METHOD.AGEING_METHOD_CODE = SA.AGEING_METHOD_CODE 
				  LEFT OUTER JOIN GFBioSQL.dbo.CATCH_SAMPLE 
				  INNER JOIN GFBioSQL.dbo.SAMPLE SM ON GFBioSQL.dbo.CATCH_SAMPLE.SAMPLE_ID = SM.SAMPLE_ID 
				  INNER JOIN GFBioSQL.dbo.CATCH C ON GFBioSQL.dbo.CATCH_SAMPLE.CATCH_ID = C.CATCH_ID ON
