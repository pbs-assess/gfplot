...
FROM GFFOS.dbo.GF_MERGED_CATCH MC
	...
	FROM GFFOS.dbo.GF_D_OFFICIAL_FE_CATCH
		...
		INNER JOIN GF_FE_TRAWL_SPECS TSP ON TSP.FISHING_EVENT_ID = C.FISHING_EVENT_ID AND TSP.FISHING_EVENT_ID = MC.FISHING_EVENT_ID
		INNER JOIN SUCCESS S ON TSP.SUCCESS_CODE = S.SUCCESS_CODE
-- insert species here
