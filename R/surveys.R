...
tidy_survey_data <- function(dat, survey, years, utm_zone = 9) {
...
fit_spatial_survey_model <- function(dat, survey, years,
  ...
  .d_tidy <- tidy_survey_data(dat, survey, years = years)
...
plot_bc_survey <- function(pred_dat, raw_dat, fill_column,
